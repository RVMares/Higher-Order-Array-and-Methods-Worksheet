...
//Filter
function findLargeItalianDishes(){
  let results = dishes.filter(function (el){
...
let largeItalianDish = findLargeItalianDishes();
console.log("Italian Foods with Serving Size Greater than Five: ", largeItalianDish)

//3. Create a function that will return only dishes whose id number matches their serving count.
//Filter
function findSameIdAndServingSize(){
  let results = dishes.filter(function (el){
...
let sameIdAndServingSize = findSameIdAndServingSize();
console.log("Dishes With Matching ID and Serving Size: ", sameIdAndServingSize)

//4. Create a function that will return only dishes whose serving count is even.
//Filter
function findEvenServingSize(){
  let results = dishes.filter(function (el){
    if (el.servings %2 === 0){
      return true;
    } else {
...
let evenServingSize = findEvenServingSize();
console.log("Dishes with Even Serving Size: ", evenServingSize)
